...
namespace Lorite.GetStartedWithCSharp.P6M05ProjectThrowAndCatchExceptions {
    ...
    public static class Program {
        ...
        public static void Main() {
            ...
            */
            ...
            string? readResult = null; // we use ? to allow null values
            ...
            registerCheckTillTotal = registerDailyStartingCash[0, 0] * registerDailyStartingCash[0, 1] + registerDailyStartingCash[1, 0] * registerDailyStartingCash[1, 1] + 
                registerDailyStartingCash[2, 0] * registerDailyStartingCash[2, 1] + registerDailyStartingCash[3, 0] * registerDailyStartingCash[3, 1];
